                    ...
                    <div className="container my-5">
                        <div className="card shadow">
                            <div className="card-body">
                                <h2 className="card-title text-center mb-4">Support</h2>
                                <div className="mb-3">
                                    <p className="mb-1"><strong>Email:</strong> <a href="" >{supportsdata.email}</a></p>
                                    <p className="mb-1"><strong>Mobile:</strong> <a href="">{supportsdata.mobile}</a></p>
                                    <p className="mb-1"><strong>WhatsApp:</strong> <a href="" target="_blank">{supportsdata.whatsapp_number}</a></p>
                                </div>
                                <div className="mb-4">
